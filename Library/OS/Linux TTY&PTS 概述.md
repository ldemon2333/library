...
![[Pasted image 20250213214108.png]]
...
## 键盘显示器直连（终端）
先看图再说话：
![[Pasted image 20250213215203.png]]
...
![[Pasted image 20250213215701.png]]
...
## 键盘显示器直连（图形界面）
![[Pasted image 20250213220446.png]]
...
这里以tmux为例介绍其原理：
![[Pasted image 20250213220757.png]]
![[Pasted image 20250213220814.png]]
...
# 常见的 TTY 配置
先先来看看当前tty的所有配置：
![[Pasted image 20250213221213.png]]
...
## SIGTTIN
当后台进程读tty时，tty将发送该信号给相应的进程组，默认行为是暂停进程组中进程的执行。

...
![[Pasted image 20241012220743.png]]
...
卷积运算是深度学习和神经网络中常用的一种操作，用于从输入数据中提取特征。Tensor Core 则是英伟达推出的一种专为加速深度学习中的矩阵计算而设计的硬件加速器，要理解卷积与 Tensor Core 之间的关系
...
![[Pasted image 20241012221315.png]]
...
![[Pasted image 20241012221355.png]]
...
![[Pasted image 20241012221426.png]]
...
![[Pasted image 20241012221624.png]]

如上图所示，在执行运算 D=AB+C，其中 A、B、C 和 D 是 4×4 矩阵。**矩阵乘法**输入 A 和 B 是 FP16 矩阵，而**累加矩阵** C 和 D 可以是 FP16 或 FP32 矩阵。
...
![[Pasted image 20241012221930.png]]
...
![[Pasted image 20241012222236.png]]
...
![[Pasted image 20241012222353.png]]

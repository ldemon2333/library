...
![[Pasted image 20241012220134.png]]
...
![Fermi 架构单个 SM 结构](../images/02Hardware03GPUBase/03Concept05.png)
...
![Fermi 架构线程分级](../images/02Hardware03GPUBase/04History02.png)
...
![Kepler 架构](../images/02Hardware03GPUBase/04History03.png)
...
![Kepler 架构改进](../images/02Hardware03GPUBase/04History04.png)
...
![Maxwell 麦克斯韦架构](../images/02Hardware03GPUBase/04History05.png)
...
![Maxwell 麦克斯韦 SM 架构](../images/02Hardware03GPUBase/04History06.png)
...
![Pascal 帕斯卡架构主要创新](../images/02Hardware03GPUBase/04History07.png)
...
![Pascal 帕斯卡架构](../images/02Hardware03GPUBase/04History08.png)
...
![Pascal 帕斯卡架构 SM](../images/02Hardware03GPUBase/04History09.png)
...
![Pascal 帕斯卡架构 NVLink](../images/02Hardware03GPUBase/04History10.png)
...
![Volta 伏特架构主要改进](../images/02Hardware03GPUBase/04History11.png)
...
![volta 伏特架构](../images/02Hardware03GPUBase/04History12.png)
...
![Volta 伏特架构 SM 结构](../images/02Hardware03GPUBase/04History13.png)
...
![Volta 伏特架构 Tensor Core 计算](../images/02Hardware03GPUBase/04History14.png)
...
![Volta 伏特架构 V100](../images/02Hardware03GPUBase/04History15.png)
...
![12 个 NVSwitch 1.0 连接 16 个 V100](../images/02Hardware03GPUBase/04History16.png)
...
![NVIDIA Turing TU102 GPU Die](../images/02Hardware03GPUBase/04History17.png)
...
![Turing 图灵架构](../images/02Hardware03GPUBase/04History18.png)
...
![Turing Tensor Core & RT Core](../images/02Hardware03GPUBase/04History19.png)
...
![RT Core 效果对比](../images/02Hardware03GPUBase/04History20.png)
...
![Ampere 安培架构主要特性](../images/02Hardware03GPUBase/04History21.png)
...
![Ampere 安培架构](../images/02Hardware03GPUBase/04History22.png)
...
![Ampere 架构 TF32、BF16 和 FP64](../images/02Hardware03GPUBase/04History23.png)
...
![Ampere 架构 A100 支持精度](../images/02Hardware03GPUBase/04History24.png)
...
![Ampere 架构稀疏化流程](../images/02Hardware03GPUBase/04History25.png)
...
![Ampere 架构多实例分割虚拟 GPU](../images/02Hardware03GPUBase/04History26.png)
...
![A100 硬件规格](../images/02Hardware03GPUBase/04History27.png)
...
![Inside NVIDIA’s First GPU-CPU Superchip](../images/02Hardware03GPUBase/04History28.png)
...
![Hopper 赫柏架构](../images/02Hardware03GPUBase/04History29.png)
...
![Hopper 赫柏架构 SM](../images/02Hardware03GPUBase/04History30.png)
...
![H100 异构系统](../images/02Hardware03GPUBase/04History31.png)
...
![NVIDIA CUDA Platform and its ecosystem](../images/02Hardware03GPUBase/04History32.png)
...
![H100-Mainstream Servers to DGX to DGX SuperPOD](../images/02Hardware03GPUBase/04History33.png)
...
![英伟达 DPU CPU+GPU GPU](../images/02Hardware03GPUBase/04History34.jpg)
...
![8 年时间 AI 计算性能提升了 1000 倍](../images/02Hardware03GPUBase/04History35.png)
...
![英伟达 GB200 NVL72 集群](../images/02Hardware03GPUBase/04History36.png)
...
![英伟达为满足模型需要不断创新](../images/02Hardware03GPUBase/04History37.jpg)
...
![GPT-3 Inference Performance](../images/02Hardware03GPUBase/04History38.jpg)
